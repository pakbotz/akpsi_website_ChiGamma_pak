...
const ALUMNI = [
  { name: 'Steve Forbes', caption: 'Editor-in-Chief, Forbes', note: 'Editor-in-chief of Forbes and two-time presidential candidate.', photo: 'gettyimages-461057770-612x612_ic0wiz', pos: '50% 0%', zoom: 1.32, contain: false },
  ...
  { name: 'Alexis Ohanian', caption: 'Co-Founder, Reddit', note: 'Co-founded Reddit, one of the web\u2019s largest communities.', photo: 'Alexis_Ohanian_1-17-2012_nwoons', pos: '50% 12%', zoom: 1.2, contain: false },
  { name: 'J. Willard Marriott', caption: 'Founder, Marriott', note: 'Turned a root-beer stand into a global hotel empire.', photo: 'j-willard-marriott-b29ffdf4-c76e-4cde-ad90-c82be1fee95-resize-750_r0jlch', pos: '50% 50%', zoom: 1, contain: true },
  { name: 'Cheryl Bachelder', caption: 'Former CEO, Popeyes', note: 'Led Popeyes through a celebrated turnaround as CEO.', photo: 'ect_backpage18__05_iz3xut', pos: '50% 35%', zoom: 1.3, contain: false },
  ...
  { name: 'James Cash Penney', caption: 'Founder, J.C. Penney', note: 'Founded J.C. Penney on a golden-rule philosophy.', photo: 'JCP-portrait_wzkkfx', pos: '50% 8%', zoom: 1.3, contain: false },
];
